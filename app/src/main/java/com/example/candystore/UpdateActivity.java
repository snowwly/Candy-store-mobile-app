    ...
    public void updateView( ) {
        ...
        if( candies.size( ) > 0 ) {
            ...
            for ( Candy candy : candies ) {
                ...
                namesAndPrices[i][0].setText( candies.get(i).getName() );
                namesAndPrices[i][1].setText( "" + candies.get(i).getPrice() );
                namesAndPrices[i][1]
                ...
                grid.addView( namesAndPrices[i][0], ( int ) ( width * 0.50 ),
                        ViewGroup.LayoutParams.WRAP_CONTENT );
                grid.addView( namesAndPrices[i][1], ( int ) ( width * 0.15 ),
                        ViewGroup.LayoutParams.WRAP_CONTENT );
                grid.addView( buttons[i], ( int ) ( width * 0.25 ),
                        ViewGroup.LayoutParams.WRAP_CONTENT );
